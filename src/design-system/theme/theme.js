...
const groupsScreen = Object.freeze({
  ...
  iconTileGreenBackground : colors.greenSoft,
...
const balancesScreen = Object.freeze({
  ...
  remindActionBackground: colors.acid,
  remindActionText: colors.nearBlack,
  settleActionBackground: colors.orange,
  settleActionText: colors.white,
  actionBackground: colors.orange,
  actionText: colors.white,
});
...
const groupDetailScreen = Object.freeze({
  ...
  remindActionBackground: balancesScreen.remindActionBackground,
  remindActionText: balancesScreen.remindActionText,
  settleActionBackground: balancesScreen.settleActionBackground,
  settleActionText: balancesScreen.settleActionText,
  actionBackground: colors.orange,
  actionText: colors.white,
